/*=========================================================================
  ...
  Module:    vtkGeometryFilterSClassifier.h
...
=========================================================================*/
// https://gitlab.kitware.com/vtk/vtk/-/blob/1410ed8aea94da56cc95d8f67e499d664d60ba73/Filters/Geometry/vtkGeometryFilter.h
/**
 * @class   vtkGeometryFilterSClassifier
 * @brief   extract geometry from data (or convert data to polygonal type)
 *
 * vtkGeometryFilterSClassifier is a general-purpose filter to extract geometry (and
 ...
 *
 * @warning
 * When vtkGeometryFilterSClassifier extracts cells (or boundaries of cells) it
 ...
 * vertices, vtkGeometryFilterSClassifier will merge these points back
...
#ifndef vtkGeometryFilterSClassifier_h
#define vtkGeometryFilterSClassifier_h
...
class VTKFILTERSGEOMETRY_EXPORT vtkGeometryFilterSClassifier : public vtkPolyDataAlgorithm
{
public:
  static vtkGeometryFilterSClassifier* New();
  vtkTypeMacro(vtkGeometryFilterSClassifier, vtkPolyDataAlgorithm);
...
protected:
  vtkGeometryFilterSClassifier();
  ~vtkGeometryFilterSClassifier() override;
...
private:
  vtkGeometryFilterSClassifier(const vtkGeometryFilterSClassifier&) = delete;
  void operator=(const vtkGeometryFilterSClassifier&) = delete;
};
