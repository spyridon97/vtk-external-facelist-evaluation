/*=========================================================================
  ...
  Module:    vtkDataSetSurfaceFilterSHash.h
...
=========================================================================*/
//https://gitlab.kitware.com/vtk/vtk/-/blob/15527a6e8ab744da0a52622fe7ab34ba6f823d8e/Filters/Geometry/vtkDataSetSurfaceFilter.h
/**
 * @class   vtkDataSetSurfaceFilterSHash
 * @brief   Extracts outer surface (as vtkPolyData) of any dataset
 *
 * vtkDataSetSurfaceFilterSHash is a general-purpose filter to extract boundary
 ...
 * subdivision. At this time vtkDataSetSurfaceFilterSHash has the distinction of
 * being able to process non-linear cells requiring subdivision. For this
 * reason, vtkDataSetSurfaceFilterSHash should be used with non-linear cells;
 ...
 * vtkGeometryFilter will delegate to vtkDataSetSurfaceFilterSHash when it
 * encounters nonlinear cells.)
 *
 * @section FastMode Fast Mode
 *
 * vtkDataSetSurfaceFilterSHash is sometimes used to simply render a 3D
 ...
 *
 * @warning
 * At one time, vtkDataSetSurfaceFilterSHash was a faster version of
 * vtkGeometryFilter when processing unstructured grids, however
 * vtkGeometryFilter is now faster. Also, vtkDataSetSurfaceFilterSHash typically
 * uses more memory than vtkGeometryFilter.  Consequently as a convenience to
 * the user, vtkDataSetSurfaceFilterSHash will delegate to vtkGeometryFilter when
 ...
 *
 * @warning
 * vtkDataSetSurfaceFilterSHash will generally not preserve topological
...
#ifndef vtkDataSetSurfaceFilterSHash_h
#define vtkDataSetSurfaceFilterSHash_h
...
class VTKFILTERSGEOMETRY_EXPORT vtkDataSetSurfaceFilterSHash : public vtkPolyDataAlgorithm
{
public:
  ///@{
  /**
   ...
   */
  static vtkDataSetSurfaceFilterSHash* New();
  vtkTypeMacro(vtkDataSetSurfaceFilterSHash, vtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent) override;

  ///@{
  /**
   * If PieceInvariant is true, vtkDataSetSurfaceFilterSHash requests
...
protected:
  vtkDataSetSurfaceFilterSHash();
  ~vtkDataSetSurfaceFilterSHash() override;
...
private:
  ...
  vtkDataSetSurfaceFilterSHash(const vtkDataSetSurfaceFilterSHash&) = delete;
  void operator=(const vtkDataSetSurfaceFilterSHash&) = delete;
};
