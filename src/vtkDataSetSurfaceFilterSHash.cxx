/*=========================================================================
  ...
  Module:    vtkDataSetSurfaceFilterSHash.cxx
...
=========================================================================*/
// https://gitlab.kitware.com/vtk/vtk/-/blob/15527a6e8ab744da0a52622fe7ab34ba6f823d8e/Filters/Geometry/vtkDataSetSurfaceFilter.cxx
...
bool StructuredExecuteWithBlanking(
  DataSetT* input, vtkPolyData* output, vtkDataSetSurfaceFilterSHash* self)
{
  if (input == nullptr)
  {
    return false;
...
class vtkDataSetSurfaceFilterSHash::vtkEdgeInterpolationMap
{
public:
...
vtkObjectFactoryNewMacro(vtkDataSetSurfaceFilterSHash);

//------------------------------------------------------------------------------
vtkDataSetSurfaceFilterSHash::vtkDataSetSurfaceFilterSHash()
{
...
//------------------------------------------------------------------------------
int vtkDataSetSurfaceFilterSHash::RequestData(vtkInformation* vtkNotUsed(request),
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::EstimateStructuredDataArraySizes(
...
//------------------------------------------------------------------------------
int vtkDataSetSurfaceFilterSHash::UniformGridExecute(
...
//------------------------------------------------------------------------------
int vtkDataSetSurfaceFilterSHash::StructuredExecute(
...
int vtkDataSetSurfaceFilterSHash::StructuredExecuteNoBlanking(
  vtkDataSet* input, vtkPolyData* output, vtkIdType* ext, vtkIdType* wholeExt)
{
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::ExecuteFaceQuads(vtkDataSet* input, vtkPolyData* output, int maxFlag,
...
//------------------------------------------------------------------------------
int vtkDataSetSurfaceFilterSHash::DataSetExecute(vtkDataSet* input, vtkPolyData* output)
{
...
//------------------------------------------------------------------------------
int vtkDataSetSurfaceFilterSHash::RequestUpdateExtent(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  // get the info objects
  vtkInformation* inInfo = inputVector[0]->GetInformationObject(0);
...
//------------------------------------------------------------------------------
int vtkDataSetSurfaceFilterSHash::FillInputPortInformation(int, vtkInformation* info)
{
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::PrintSelf(ostream& os, vtkIndent indent)
{
...
int vtkDataSetSurfaceFilterSHash::UnstructuredGridExecute(vtkDataSet* dataSetInput, vtkPolyData* output)
{
...
// vtkDataSetSurfaceFilterSHash coordinate their efforts.
int vtkDataSetSurfaceFilterSHash::UnstructuredGridExecute(
...
int vtkDataSetSurfaceFilterSHash::UnstructuredGridBaseExecute(
...
int vtkDataSetSurfaceFilterSHash::UnstructuredGridExecuteInternal(
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::InitializeQuadHash(vtkIdType numPoints)
{
  vtkIdType i;
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::DeleteQuadHash()
{
  vtkIdType i;
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::InsertQuadInHash(
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::InsertTriInHash(
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::InsertPolygonInHash(
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::InitFastGeomQuadAllocation(vtkIdType numberOfCells)
{
  int idx;
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::DeleteAllFastGeomQuads()
{
...
//------------------------------------------------------------------------------
vtkFastGeomQuad* vtkDataSetSurfaceFilterSHash::NewFastGeomQuad(int numPts)
{
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::InitQuadHashTraversal()
{
...
//------------------------------------------------------------------------------
vtkFastGeomQuad* vtkDataSetSurfaceFilterSHash::GetNextVisibleQuadFromHash()
{
...
//------------------------------------------------------------------------------
vtkIdType vtkDataSetSurfaceFilterSHash::GetOutputPointId(
...
//------------------------------------------------------------------------------
vtkIdType vtkDataSetSurfaceFilterSHash::GetOutputPointIdAndInterpolate(vtkIdType inPtId,
...
//------------------------------------------------------------------------------
vtkIdType vtkDataSetSurfaceFilterSHash::GetInterpolatedPointId(vtkIdType edgePtA, vtkIdType edgePtB,
...
vtkIdType vtkDataSetSurfaceFilterSHash::GetInterpolatedPointId(vtkDataSet* input, vtkCell* cell,
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::RecordOrigCellId(vtkIdType destIndex, vtkIdType originalId)
{
  if (this->OriginalCellIds != nullptr)
  {
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::RecordOrigCellId(vtkIdType destIndex, vtkFastGeomQuad* quad)
{
  if (this->OriginalCellIds != nullptr)
  {
...
//------------------------------------------------------------------------------
void vtkDataSetSurfaceFilterSHash::RecordOrigPointId(vtkIdType destIndex, vtkIdType originalId)
{
  if (this->OriginalPointIds != nullptr)
  {
