/*=========================================================================
  ...
  Module:    vtkGeometryFilterPClassifier.cxx
...
=========================================================================*/
// https://gitlab.kitware.com/vtk/vtk/-/blob/c44fd2ba0d86779d65f5eda56a1aaceff2954807/Filters/Geometry/vtkGeometryFilter.cxx
...
vtkStandardNewMacro(vtkGeometryFilterPClassifier);
vtkCxxSetObjectMacro(vtkGeometryFilterPClassifier, Locator, vtkIncrementalPointLocator);

//------------------------------------------------------------------------------
// Construct with all types of clipping turned off.
vtkGeometryFilterPClassifier::vtkGeometryFilterPClassifier()
{
  this->PointMinimum = 0;
...
void vtkGeometryFilterPClassifier::SetExtent(
...
//------------------------------------------------------------------------------
// Specify a (xmin,xmax, ymin,ymax, zmin,zmax) bounding box to clip data.
void vtkGeometryFilterPClassifier::SetExtent(double extent[6])
{
  int i;
...
//------------------------------------------------------------------------------
void vtkGeometryFilterPClassifier::SetOutputPointsPrecision(int precision)
{
...
//------------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::GetOutputPointsPrecision() const
{
...
//----------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::RequestData(vtkInformation* vtkNotUsed(request),
...
void vtkGeometryFilterPClassifier::CreateDefaultLocator() {}

//------------------------------------------------------------------------------
void vtkGeometryFilterPClassifier::SetExcludedFacesData(vtkPolyData* input)
{
...
void vtkGeometryFilterPClassifier::SetExcludedFacesConnection(vtkAlgorithmOutput* algOutput)
{
...
vtkPolyData* vtkGeometryFilterPClassifier::GetExcludedFaces()
{
...
//------------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::FillInputPortInformation(int port, vtkInformation* info)
{
  if (port == 0)
  {
...
//------------------------------------------------------------------------------
void vtkGeometryFilterPClassifier::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  LocalDataType* localData)
{
  ...
  switch (cellType)
  {
    ...
    default:
      // Other types of 3D linear cells handled by vtkGeometryFilterPClassifier. Exactly what
...
//------------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::PolyDataExecute(vtkDataSet* dataSetInput, vtkPolyData* output)
{
...
int vtkGeometryFilterPClassifier::PolyDataExecute(
...
//----------------------------------------------------------------------------
vtkGeometryFilterPClassifierHelper* vtkGeometryFilterPClassifierHelper::CharacterizeUnstructuredGrid(
  vtkUnstructuredGrid* input)
{
  vtkGeometryFilterPClassifierHelper* info = new vtkGeometryFilterPClassifierHelper;
...
//----------------------------------------------------------------------------
void vtkGeometryFilterPClassifierHelper::CopyFilterParams(vtkGeometryFilterPClassifier* gf, vtkDataSetSurfaceFilter* dssf)
{
...
//----------------------------------------------------------------------------
void vtkGeometryFilterPClassifierHelper::CopyFilterParams(vtkDataSetSurfaceFilter* dssf, vtkGeometryFilterPClassifier* gf)
{
  // Helper method to copy key parameters from an instance of
  // vtkDataSetSurfaceFilter to vtkGeometryFilterPClassifier. This is for delegation.
...
//----------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::UnstructuredGridExecute(vtkDataSet* dataSetInput, vtkPolyData* output)
{
...
//----------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::UnstructuredGridExecute(vtkDataSet* dataSetInput, vtkPolyData* output,
  vtkGeometryFilterPClassifierHelper* info, vtkExcludedFaces* exc)
{
  ...
  // to the faster vtkGeometryFilterPClassifier.
  bool mayDelegate = (info == nullptr && this->Delegation);
  if (info == nullptr)
  {
    info = vtkGeometryFilterPClassifierHelper::CharacterizeUnstructuredGrid(input);
  }
  ...
  if (!info->IsLinear && mayDelegate)
  {
    ...
    vtkGeometryFilterPClassifierHelper::CopyFilterParams(this, dssf.Get());
    dssf->UnstructuredGridExecute(dataSetInput, output);
    delete info;
    return 1;
  }
...
int vtkGeometryFilterPClassifier::StructuredExecute(vtkDataSet* input, vtkPolyData* output, vtkInformation*)
{
  return this->StructuredExecute(input, output, nullptr, nullptr);
}

//------------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::StructuredExecute(
...
//------------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::DataSetExecute(vtkDataSet* input, vtkPolyData* output)
{
  return this->DataSetExecute(input, output, nullptr);
}

//------------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::DataSetExecute(vtkDataSet* input, vtkPolyData* output, vtkExcludedFaces* exc)
{
  vtkIdType cellId;
  int i;
  vtkIdType numCells = input->GetNumberOfCells();
...
//------------------------------------------------------------------------------
int vtkGeometryFilterPClassifier::RequestUpdateExtent(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  // get the info objects
  vtkInformation* inInfo = inputVector[0]->GetInformationObject(0);
