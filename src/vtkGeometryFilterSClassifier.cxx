/*=========================================================================
  ...
  Module:    vtkGeometryFilterSClassifier.cxx
...
=========================================================================*/
// https://gitlab.kitware.com/vtk/vtk/-/blob/1410ed8aea94da56cc95d8f67e499d664d60ba73/Filters/Geometry/vtkGeometryFilter.cxx
...
vtkStandardNewMacro(vtkGeometryFilterSClassifier);
vtkCxxSetObjectMacro(vtkGeometryFilterSClassifier, Locator, vtkIncrementalPointLocator);

//------------------------------------------------------------------------------
// Construct with all types of clipping turned off.
vtkGeometryFilterSClassifier::vtkGeometryFilterSClassifier()
{
  this->PointMinimum = 0;
...
void vtkGeometryFilterSClassifier::SetExtent(
...
//------------------------------------------------------------------------------
// Specify a (xmin,xmax, ymin,ymax, zmin,zmax) bounding box to clip data.
void vtkGeometryFilterSClassifier::SetExtent(double extent[6])
{
  int i;
...
void vtkGeometryFilterSClassifier::SetOutputPointsPrecision(int precision)
{
...
int vtkGeometryFilterSClassifier::GetOutputPointsPrecision() const
{
  return this->OutputPointsPrecision;
}

//------------------------------------------------------------------------------
int vtkGeometryFilterSClassifier::RequestData(vtkInformation* vtkNotUsed(request),
...
void vtkGeometryFilterSClassifier::CreateDefaultLocator()
{
  if (this->Locator == nullptr)
  {
...
//------------------------------------------------------------------------------
int vtkGeometryFilterSClassifier::FillInputPortInformation(int, vtkInformation* info)
{
...
//------------------------------------------------------------------------------
void vtkGeometryFilterSClassifier::PrintSelf(ostream& os, vtkIndent indent)
{
...
//------------------------------------------------------------------------------
vtkMTimeType vtkGeometryFilterSClassifier::GetMTime()
{
...
//------------------------------------------------------------------------------
void vtkGeometryFilterSClassifier::PolyDataExecute(vtkDataSet* dataSetInput, vtkPolyData* output)
{
...
//------------------------------------------------------------------------------
void vtkGeometryFilterSClassifier::UnstructuredGridExecute(vtkDataSet* dataSetInput, vtkPolyData* output)
{
...
//------------------------------------------------------------------------------
void vtkGeometryFilterSClassifier::StructuredGridExecute(
...
//------------------------------------------------------------------------------
int vtkGeometryFilterSClassifier::RequestUpdateExtent(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  // get the info objects
  vtkInformation* inInfo = inputVector[0]->GetInformationObject(0);
